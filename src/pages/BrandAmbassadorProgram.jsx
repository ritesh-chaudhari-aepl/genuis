...
import CenterContentCard from "../components/cards/CenterContentCard";
import BrandAmbassadorForm from "../components/containers/BrandAmbassadorForm";
import { useState } from "react";
import { Link } from "react-scroll";
const BrandAmbassadorProgram = () => {
  ...
  return (
    <>
      <SEO
        ...
        description="Get an opportunity to become a brand ambassador with Genius Tutors! Join our team and elevate your student experience while gaining valuable skills."
      />
      <div id="brand-form-section" className="bg-primaryWhite pb-10">
        <section id="brand-ambassador-program">
                ...
                <div className="">
                  <div className=" pt-1 px-6 lg:px-0">
                    ...
                    <p className="text-black py-3 text-sm mt-3 font-normal leading-[25px] font-Inter sm:text-base sm:leading-[27px]">
                      ...
                      exceptional college homework assistance at affordable
                      prices. Our main focus is on meeting your academic needs
          ...
          <div className="relative mx-auto max-w-screen-xl justify-center container items-center grid grid-cols-1 gap-12 py-16">
            <div className="xl:flex grid grid-cols-1 items-center justify-center">
              ...
              <p className="xl:w-1/2 text-black text-sm mt-3 font-semibold font-Inter sm:text-base sm:leading-[27px]">
                ...
                over an extended period, and the best part – it&apos;s
                absolutely FREE! Here&apos;s why you should consider joining our
                network:
              </p>
            </div>
            ...
            <p>
              Embark on this exciting journey with us and make a lasting impact
              on the educational landscape while enjoying the perks of being a
              valued Brand Ambassador for Genius Tutors!
            </p>
          ...
          <div className="flex items-center justify-center py-16">
            <Link
              to="brand-form-section"
              spy={true}
              smooth={true}
              offset={-marginTop} // Adjust for the header height
              duration={500}
...
export default BrandAmbassadorProgram;
