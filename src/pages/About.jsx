  ...
  return (
    <>
      <SEO
        ...
        description="Discover the story behind Genius Tutors, a leading academic help platform committed to empowering students through personalized learning."
      />
                ...
                <div className="">
                  <div className=" pt-1 px-6 lg:px-0">
                    ...
                    <p className="text-black py-3 text-sm mt-3 font-normal leading-[25px] font-Inter sm:text-base sm:leading-[27px]">
                      At Genius Tutors, we are dedicated to providing
                      exceptional homework assistance at affordable prices. Our
                      main focus is on meeting your academic needs without
                    ...
                    <div className="px-5 space-y-3 pt-4">
                      ...
                      <p className="flex gap-2 flex-row italic  text-black">
                        <MdDoneAll size={20} color="blue" /> Never Miss a
                        Deadline
                      </p>
                      <p className="flex gap-2 flex-row italic  text-black">
                      ...
                      <p className="flex gap-2 flex-row italic  text-black">
                        <MdDoneAll size={20} color="blue" /> Your Privacy is
                        Fully Protected
                      </p>
                    </div>
                  </div>
          ...
          <div className="relative mx-auto max-w-screen-xl container items-center grid grid-cols-1 gap-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="content-part grid gap-3">
                  ...
                  <p className="text-justify leading-7 tracking-wide ">
                    Welcome to Genius Tutors, a prominent academic writing
                    service that holds a significant presence in the global
                    education market. Our mission is to provide top-notch
                    academic writing services, assisting thousands of students
                    in achieving excellent grades during their MBA education
                    journey.
                  </p>
                  <p className="text-justify leading-7 tracking-wide ">
                    As a leading academic writing service, we entrust your
                    assignments to our highly qualified and experienced team of
                    subject matter experts. Their proficiency, honed through
                    years of practical experience and advanced research skills,
                    allows them to deliver high-quality assignments even under
                    tight deadlines.
                  </p>
                  <p className="text-justify leading-7 tracking-wide ">
                  ...
                  <p className="text-justify leading-7 tracking-wide ">
                    ...
                    prioritizing the delivery of high-quality assignments.
                    Through significant investments in quality control and
                    monitoring, our goal is to guarantee that each client
                    receives top-notch content, resulting in high grades for
                    every assignment we handle.
                  </p>
                </div>
            ...
            <div className="grid gap-3 px-6">
              ...
              <p className="text-justify leading-7 tracking-wide ">
                ...
                customer base exceeding 100,000, Genius Tutors has emerged as a
