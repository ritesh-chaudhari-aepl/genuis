                ...
                <div className="p-2 w-1/2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      // id="name"
                      name="name"
                      className="w-full rounded-[3px] bg-white border border-[#D7E0EF] focus:border-indigo-500 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    />
                  </div>
                </div>
                <div className="p-2 w-1/2">
