...
export const documentProps = {
  ...
  description:
    "Unlock the full potential of education with Genius Tutors. Discover a range of cutting-edge features designed to elevate academic success.",
  canonical: "https://thegeniustutors.com/features",
  url: "https://thegeniustutors.com/features",
};
            ...
            <div className="grid grid-cols-1 items-center lg:grid-cols-2 gap-4">
              <div className=" px-6">
                ...
                <p className=" text-black text-sm mt-3 font-medium font-Inter sm:text-base sm:leading-[27px]">
                  ...
                  guidance and comprehensive resources. Explore our features and
